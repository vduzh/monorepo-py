...
def cli():
    ...
    container.config.lm.embeddings.from_env('EMBEDDINGS', default='openai')
    container.config.store.chromadb_client.from_env('CHROMADB_CLIENT', default='in_memory')
    container.config.store.chromadb_client_http_host.from_env('CHROMADB_HTTP_CLIENT_HOST', default='localhost')
    container.config.store.chromadb_client_http_port.from_env('CHROMADB_HTTP_CLIENT_PORT', default="8000")
